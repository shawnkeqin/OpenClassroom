...
INPUT1_FILEPATH <-
  "semester-1-fall-2020-formatted-20200708.csv"

INPUT2_FILEPATH <- 
  "semester-1-fall-2020-raw-20200926.csv"
reformat <- read.csv(INPUT2_FILEPATH, stringsAsFactors = FALSE)
write.csv(reformat, "semester-1-fall-2020-raw-20200926.csv",row.names = FALSE)
...
write.csv(input2_with_faculty_names, "semester-1-fall-2020-raw-20200926-with-id.csv",row.names = FALSE)
