...
INPUT_FILEPATH <-
  "Semester 2 AY20202021_As of 29 Dec 2020/All-1-Table 1.csv"
CC_LECTURES_FILEPATH <-
  "Semester 2 AY20202021_As of 29 Dec 2020/CC-1-Table 1.csv"
# Declare some value constants.;
SEMESTER_CODE <- "AY2021-2"
TIMEZONE <- "+08:00"
DATE_FORMAT <- "%d-%m-%Y"
STARTING_SUNDAY_DATE <-
  as.Date("10-01-2021", DATE_FORMAT) # Sunday of week 1.
WEEK_MAPPING <-
...
seminar <- seminar %>%
  mutate(
    location_code = recode(
      ...
      "UTSRC - AUD2" = "UTSRC-AUD2",
      "SRC-AUD02" = "UTSRC-AUD2",
      "Y-ELMECL" = "Y-ELMCL",
      "Y-Studio2" = "Y-ArtsStud",
      "Y-ArtsStud\nY-Studio3" = "Y-ArtsStud",
      "Y-Arts Stud" = "Y-ArtsStud",
      "Y-Arts Stud 2" = "Y-ArtsStud",
      "Y-LifeSci" = "Y-LSciLab",
      "K-Chanrai" = "Y-KChanrai"
    )
  )
